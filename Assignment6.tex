...
Data for Alexander Street was not available in (Bredenhann, 2022), so it was assumed to have similar flows to Merriman Avenue. $p \in [0.1, 0.2]$ was selected as a reasonable range.
